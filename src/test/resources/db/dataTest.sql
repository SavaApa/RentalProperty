...
VALUES (X'915ffd163eaa4fafb4fe52a59ac040aa', 'landlord1@example.com', 'password123'),
       (X'ab587544256748b09b15a7f178071fde', 'tenant1@example.com', 'password456');

INSERT INTO users (u_id, first_name, last_name, user_info_id, tenant_id, landlord_id)
VALUES (X'590f1736304048279847e4160678671b', 'John', 'Doe', X'915ffd163eaa4fafb4fe52a59ac040aa', NULL, X'e8240961836b43cc948c4fb4d2cbcb18'),
       (X'654cc27a10824e6486b993003c5d2ad2', 'Jane', 'Smith', X'ab587544256748b09b15a7f178071fde', X'bb49bdc24d9b4016ba0ab0016d1dd575', NULL);
