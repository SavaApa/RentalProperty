package com.example.rentalproperty.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.example.rentalproperty.controller.*.*(..))")
    public void controllerLog() {
    }

    @Pointcut("execution(public * com.example.rentalproperty.service.*.*(..))")
